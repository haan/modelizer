        ...
        <div className="flex items-start gap-2">
          <div className="flex min-w-0 flex-1 flex-col gap-2">
            <div className="flex flex-row items-center gap-1">
              ...
              <span className="font-bold text-base-content/70">Table From</span>
            </div>
            ...
            <button type="button" className="text-left">
              <div className="truncate text-sm">{sourceAttributeLabel}</div>
            </button>
          </div>
          <div className="flex min-w-0 flex-1 flex-col gap-2">
            <div className="flex flex-row items-center gap-1">
              ...
              <span className="font-bold text-base-content/70">Table To</span>
            </div>
            <button type="button" className="text-left">
            ...
            <button type="button" className="text-left">
              <div className="truncate text-sm">{targetAttributeLabel}</div>
            </button>
          </div>
        </div>
