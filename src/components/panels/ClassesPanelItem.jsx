  ...
  return (
    ...
    >
      <summary className="list-none cursor-pointer [&::-webkit-details-marker]:hidden">
        <div className="w-full rounded-l-md border-b border-base-content/20 group-open:border-b-0">
          <div
          ...
          >
            ...
            <button
              className="ml-auto inline-flex h-6 w-6 items-center justify-center rounded-md text-base-content/60 opacity-0 transition-opacity hover:bg-base-300 hover:text-base-content group-hover:opacity-100"
              type="button"
              onClick={(event) => {
                event.stopPropagation()
                startEditing()
